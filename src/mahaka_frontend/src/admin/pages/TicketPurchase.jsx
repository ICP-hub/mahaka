...
const TicketPurchase = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md w-4/5 mx-auto">
        <div className="flex justify-center mb-6">
          <div className="h-1 w-16 bg-orange-400 rounded-full"></div>
        </div>
        <h2 className="text-2xl font-semibold text-gray-700 text-center mb-8">MAIN GATE TICKET</h2>

        {/* Date Picker */}
        <div className="mb-8">
          <label htmlFor="datePicker" className="block text-gray-700 font-semibold mb-2">Select a date</label>
          <input
            id="datePicker"
            type="date"
            value={selectedDate}
        ...
        {[
          ...
          <div key={ticket.type} className="flex items-center justify-between mb-6">
            <span className="text-gray-700 font-semibold">{ticket.label}</span>
            <div className="flex items-center space-x-2">
              ...
              <span className="text-gray-700 font-semibold w-8 text-center">{visitorCounts[ticket.type]}</span>
              <button
        ...
        {/* Price Display */}
        <div className="text-lg font-bold text-gray-700 mb-8">
