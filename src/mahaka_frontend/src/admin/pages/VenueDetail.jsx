  ...
  return (
    <div className="flex w-full flex-col">
      <div className="relative h-40 w-full bg-accent-100 px-8 dark:bg-accent-700 sm:h-48 sm:px-12">
        <img
          src={currentVenue.ok?.banner?.data}
          alt="framer_3"
          ...
          <div className="mt-2 flex flex-wrap items-center">
            <div className="mb-3 mr-3 flex items-center justify-center rounded-full bg-gray-100 px-3 py-1 leading-normal text-gray-500 dark:bg-gray-700 dark:text-gray-300">
              <span className="whitespace-nowrap text-sm font-medium">
                Creator : {currentVenue.ok.creator.toText()}
              </span>
            </div>
          </div>
          <div className="mt-4 flex flex-col space-y-8 border-t pt-6">
            <div className="flex sm:items-center">
              ...
              <div className="ml-6 leading-6">
                {currentVenue.ok.Details.Location}
              </div>
            </div>
            <div className="flex sm:items-center">
              <p>Maximum Capacity</p>
              <div className="ml-6 leading-6">
                {parseInt(currentVenue.ok.capacity)}
              </div>
            </div>
            {/* <div className="flex sm:items-center">
              <p>Start Date</p>
            ...
            <div className="flex sm:items-center">
              <p>Venue id</p>
              <div className="ml-6 leading-6">{currentVenue.ok.id}</div>
            </div>
            <div className="flex">
              <p>Venue Description</p>
              <div className="prose prose-sm ml-6 max-w-none">
                <p>{currentVenue.ok.Description}</p>
              </div>
            </div>
          </div>
        </div>
...
//   const venue =
//     currentVenue && Array.isArray(currentVenue) ? currentVenue.ok : null;
