...
const confirmDeleteBanner = (bannerDelete)=>{
  ...
  dispatch(clearAllBanners({backend,category:bannerDelete.category}))
      ...
      {deleteModalVisible && (
        <div className="fixed inset-0 z-50 flex items-center rounded justify-center bg-black bg-opacity-50">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
         value={Object.keys(bannerDelete?.category || { ThirdParty: null })[0]}  // Extracting the key from the category object
  onChange={(e) =>
    setBannerDelete({
...
{bannerLoading ? <Loader/>:(
  ...
  {/* First Section */}
    ...
    <h2 className="text-2xl font-bold text-gray-800 mb-4 justify-start flex">Attraction Banners</h2>
