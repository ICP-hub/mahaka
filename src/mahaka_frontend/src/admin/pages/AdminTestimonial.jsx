...
const SkeletonLoader = () => {
  return (
    ...
    return (
        <div>
          {deleteModalVisible && <DeleteEventModal setDeleteModalVisible ={setDeleteModalVisible} onTestimonialDelete = {onTestimonialDelete}/>}
           <ModalOverlay
          isOpen={isModalOpen}
...
<div>
  {testimonialLoading ? (
    ...
    <div className ="mt-10 text-gray-600 text-3xl font-bold flex justify-center">No Testimonials Found</div> // Display a "No Testimonials" message
  )}
</div>
...
export const DeleteEventModal = ({onTestimonialDelete ,setDeleteModalVisible}) => {
    ...
    <div className="fixed inset-0 z-999 flex items-center rounded justify-center bg-black bg-opacity-50">
      <div className="bg-card p-6 rounded-2xl shadow-lg">
        ...
        <div className="flex justify-end">
          ...
          <button className="px-4 py-2" onClick={()=>setDeleteModalVisible(false)}>
            Cancel
          </button>
        </div>
      </div>
