...
// input field
const FormFieldInput = ({ type, value, onChange, label }) => {
  return (
...
// input options
const FormFieldOptions = ({ value, onChange, label, optionInit, options }) => {
  return (
    <div className="relative">
      <div className="absolute inset-0 border border-border rounded-md -z-1"></div>
      <select
...
// Form field image
const FormFieldImageUpload = ({ label, image, onChange }) => {
...
const FormFieldDate = ({ value, onChange, label, minDate = "" }) => {
...
const FormFieldTime = ({ value, onChange, label }) => {
  const inputRef = useRef(null);
